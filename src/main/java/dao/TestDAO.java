...
public class TestDAO {
    public static void main(String[] args) {
        ...
        // Test lookup by phone (auth is now passwordless via SMS OTP)
        User u = userDAO.getByPhone("+212600000000");
        System.out.println("getByPhone : " + (u != null ? " " + u : " FAIL"));
        ...
        grpDAO.addMember(gid, 2, false);
        grpDAO.addMember(gid, 3, false);
