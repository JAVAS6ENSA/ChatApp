...
public class clientAPP {
    ...
    public void createGroup(String name, java.util.List<String> members) {
        String mStr = String.join(",", members);
        send("GROUP_CREATE|" + name + "|" + mStr);
    }

    public void sendGroupMessage(int groupId, String content) {
        send("GROUP_MSG|" + groupId + "|" + content);
    }

    public void addGroupMember(int groupId, String username) {
        send("GROUP_ADD|" + groupId + "|" + username);
    }

    public void removeGroupMember(int groupId, String username) {
        send("GROUP_REMOVE|" + groupId + "|" + username);
    }

    public void getGroupHistory(int groupId) {
        send("GROUP_HISTORY|" + groupId);
    }
    ...
    public void sendGroupAudio(int groupId, String base64) {
        send("GROUP_AUDIO|" + groupId + "|" + base64);
    }

    public void sendGroupFile(int groupId, String fileName, String base64) {
        send("GROUP_FILE|" + groupId + "|" + fileName + "|" + base64);
    }
}
