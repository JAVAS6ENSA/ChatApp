...
public class serveur {
    ...
    private final GroupCallManager groupCallManager = new GroupCallManager();
    ...
    public void startServer() {
        try {
            ...
            while (true) {
                ...
                clientHandler newClient = new clientHandler(socket, sessionManager, appelManager, groupCallManager);
